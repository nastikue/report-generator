    ...
    return (
        <div>
            ...
            <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
                {stage === Stage.TitlePage && (
                    <form onSubmit={handleSubmit}>
                        <h1>Title</h1>
                        <InputElement
                            name="projectName"
                            placeholder="Project Name"
                            onInputChange={handleReportChange}
                        />
                        <p>Mentor:</p>
                        <InputElement
                            name="firstName"
                            placeholder="Mentor Name"
                            onInputChange={handleMentorNameChange}
                        />
                        <InputElement
                            name="secondName"
                            placeholder="Mentor Surname"
                            onInputChange={handleMentorNameChange}
                        />
                        <button type="submit">Next</button>
                    </form>
                )}
                {stage === Stage.InfoPage && (
                    <form>
                        <h1>Info</h1>
                        <InputElement
                            type="url"
                        ...
                        <InputElement
                            type="url"
                            name="sprintsReports"
                            placeholder="Link to Sprints Report"
                            onInputChange={handleReportChange}
                        />
                        <InputElement
                            type="url"
                            name="app"
                            placeholder="Link to Web App"
                            onInputChange={handleReportChange}
                        />
                        <InputElement
                        ...
                        <div className="buttons-container">
                            <button onClick={() => setStage(Stage.TitlePage)}>
                                {'<'}- Back
                            </button>
                            <button onClick={() => setStage(Stage.RolePage)}>
                                Next -{'>'}
                            </button>
                        </div>
                    </form>
                )}
                {stage === Stage.RolePage && (
                    <form>
                        <h1>Role responsibilities</h1>
                        <div className="buttons-container">
                            <button onClick={() => setStage(Stage.InfoPage)}>
                                {'<'}- Back
                            </button>
                            <button onClick={() => setStage(Stage.RolePage)}>
                                + Add Another Role
                            </button>
                            <button onClick={() => setStage(Stage.Additions)}>
                                Next -{'>'}
                            </button>
                        </div>
                    </form>
                )}
                {stage === Stage.Additions && (
                    <form>
                        <h1>Additions</h1>
                        <div className="buttons-container">
                            <button onClick={() => setStage(Stage.RolePage)}>
